...
| 🕸️ | **Cleaner input for GraphRAG** | Preserve sentence context and section boundaries for downstream entity, relationship, and topic extraction. [Why it matters](#cleaner-input-for-graphrag). |
...
- [Cleaner input for GraphRAG](#cleaner-input-for-graphrag)
